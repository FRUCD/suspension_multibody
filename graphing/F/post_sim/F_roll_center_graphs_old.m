function F_roll_center_graphs_old(~, out)
    H_1 = figure(...
    ...
    plot(...
        out.F.SY.roll_angle.Data(:, 1), ...
        1000 * out.FL.SY.instant_center.Data(:, 1))
    grid on;
    ...
    plot(...
        out.F.SY.roll_angle.Data(:, 1), ...
        1000 * out.FL.SY.instant_center.Data(:, 2))
    grid on;
    xlabel('Roll Angle (deg)')
    ylabel('Z (mm)')
    hold off
    ...
    plot(...
        out.F.SY.roll_angle.Data(:, 1), ...
        1000 * out.FR.SY.instant_center.Data(:, 1))
    grid on;
    xlabel('Roll Angle (deg)')
    ylabel('Y (mm)')
    hold off
    ...
    plot(...
        out.F.SY.roll_angle.Data(:, 1), ...
        1000 * out.FR.SY.instant_center.Data(:, 2))
    grid on;
    xlabel('Roll Angle (deg)')
    ylabel('Z (mm)')
    hold off
    ...
    plot(...
        out.F.SY.roll_angle.Data(:, 1), ...
        1000 * out.F.SY.roll_center.Data(:, 1))
    grid on;
    xlabel('Roll Angle (deg)')
    ylabel('Y (mm)')
    hold off
    ...
    plot(...
        out.F.SY.roll_angle.Data(:, 1), ...
        1000 * out.F.SY.roll_center.Data(:, 2))
    grid on;
    xlabel('Roll Angle (deg)')
    ylabel('Z (mm)')
    hold off
