function F_MR_sweep(SP)

    %% define sweep parameters
    sw_p.SH_radius_range = 0.5;
    sw_p.radius_ratio_range = 0.15;
    sw_p.angle_range = 10;
    ...
    sw.SH_radius = ...
        linspace(...
            SP.F.RA.SH_radius - sw_p.SH_radius_range, ...
            SP.F.RA.SH_radius + sw_p.SH_radius_range, ...
            sw_p.SH_radius_n_points);
    sw.length_ratio = ...
        linspace(...
            SP.F.RA.SH_radius / SP.F.RA.PR_radius ...
    ...
    sw.angle = ...
        linspace(...
            SP.F.RA.angle - sw_p.angle_range, ...
            SP.F.RA.angle + sw_p.angle_range, ...
            sw_p.angle_n_points);
 
    %% launch a figure, annotate, maximize
    figure(...
        'Name', 'Front MR Sweeps', ...
        'NumberTitle', 'off', ...
        'Color', 'white', ...
    ...
    for i = 1:sw_p.SH_radius_n_points
        for j = 1:sw_p.radius_ratio_n_points
            ...
            for k = 1:sw_p.angle_n_points
                SP_temp.F.RA.SH_radius = sw.SH_radius(i);
                SP_temp.F.RA.PR_radius = ...
                    sw.SH_radius(i) / sw.length_ratio(j);
                SP_temp.F.RA.angle = sw.angle(k);
                SP_temp = SP_temp.F_AC_geometry;
                
                MR_arrays{i, j, k} = SP_temp.F.SY.MR_array;
                ...
                plot(...
                    SP_temp.F.SY.jounce_array * 1000, ...
                    MR_arrays{i, j, k}, ...
                    'Color', ...
    ...
    for i = 1:sw_p.SH_radius_n_points
        for j = 1:sw_p.radius_ratio_n_points
            subplot(...
                ...
                sw_p.radius_ratio_n_points, ...
                (i - 1) * sw_p.SH_radius_n_points + j);
            axis([SP_temp.F.SY.jounce_array(1) * 1000, ...
                  SP_temp.F.SY.jounce_array(end) * 1000, ...
                  min_MR - 0.02, ...
                  max_MR + 0.02]);
            axis([-40, 40, 0.8, 1.2])
        end
