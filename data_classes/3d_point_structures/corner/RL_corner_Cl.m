classdef RL_corner_Cl < corner_Cl
    %% RL_CORNER_CL Rear Left Corner Class
    %   stores 3D points for a corner of the car (rear left)

    %% part structures for 3D points
    properties
        CH (1,1) RL_CH_points_Cl;
        UA (1,1) RL_UA_points_Cl;
        LA (1,1) RL_LA_points_Cl;
        TL (1,1) RL_TL_points_Cl;
        SH (1,1) RL_SH_points_Cl;
        RA (1,1) RL_RA_points_Cl;
        PR (1,1) RL_PR_points_Cl;
        WP (1,1) RL_WP_points_Cl;
    end
