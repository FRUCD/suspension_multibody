classdef FR_corner_Cl < corner_Cl
    %% FR_CORNER_CL Front Right Corner Class
    %   stores 3D points for a corner of the car (front right)

    %% part structures for 3D points
    properties
        CH (1,1) FR_CH_points_Cl;
        RK (1,1) FR_RK_points_Cl;
        UA (1,1) FR_UA_points_Cl;
        LA (1,1) FR_LA_points_Cl;
        TL (1,1) FR_TL_points_Cl;
        SH (1,1) FR_SH_points_Cl;
        RA (1,1) FR_RA_points_Cl;
        PR (1,1) FR_PR_points_Cl;
        WP (1,1) FR_WP_points_Cl;
    end
